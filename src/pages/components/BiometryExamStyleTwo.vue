        ...
        <table class="biometry-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.right_eye_k1" :min="0" :precision="2" :step="0.25" style="width: 100%" placeholder="D" />
                </template>
                <template v-else>{{ formatValue(record?.right_eye_k1) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.left_eye_k1" :min="0" :precision="2" :step="0.25" style="width: 100%" placeholder="D" />
                </template>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.right_eye_k2" :min="0" :precision="2" :step="0.25" style="width: 100%" placeholder="D" />
                </template>
                <template v-else>{{ formatValue(record?.right_eye_k2) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.left_eye_k2" :min="0" :precision="2" :step="0.25" style="width: 100%" placeholder="D" />
                </template>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <span style="color: #666;">{{ formatValue(calculateDeltaK(viewMode === 'edit' ? editForm.right_eye_k1 : record?.right_eye_k1, viewMode === 'edit' ? editForm.right_eye_k2 : record?.right_eye_k2)) }}</span>
                </template>
                <template v-else>{{ formatValue(calculateDeltaK(record?.right_eye_k1, record?.right_eye_k2)) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <span style="color: #666;">{{ formatValue(calculateDeltaK(viewMode === 'edit' ? editForm.left_eye_k1 : record?.left_eye_k1, viewMode === 'edit' ? editForm.left_eye_k2 : record?.left_eye_k2)) }}</span>
                </template>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <span style="color: #666;">{{ formatValue(calculateAvgK(viewMode === 'edit' ? editForm.right_eye_k1 : record?.right_eye_k1, viewMode === 'edit' ? editForm.right_eye_k2 : record?.right_eye_k2)) }}</span>
                </template>
                <template v-else>{{ formatValue(calculateAvgK(record?.right_eye_k1, record?.right_eye_k2)) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <span style="color: #666;">{{ formatValue(calculateAvgK(viewMode === 'edit' ? editForm.left_eye_k1 : record?.left_eye_k1, viewMode === 'edit' ? editForm.left_eye_k2 : record?.left_eye_k2)) }}</span>
                </template>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <span style="color: #666;">{{ formatValue(calculateAxialRatio(viewMode === 'edit' ? editForm.right_eye_axial_length : record?.right_eye_axial_length, viewMode === 'edit' ? editForm.right_eye_k1 : record?.right_eye_k1, viewMode === 'edit' ? editForm.right_eye_k2 : record?.right_eye_k2)) }}</span>
                </template>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <span style="color: #666;">{{ formatValue(calculateAxialRatio(viewMode === 'edit' ? editForm.left_eye_axial_length : record?.left_eye_axial_length, viewMode === 'edit' ? editForm.left_eye_k1 : record?.left_eye_k1, viewMode === 'edit' ? editForm.left_eye_k2 : record?.left_eye_k2)) }}</span>
                </template>
              ...
              <td class="unit-cell">参考值 <span style="font-size: 1.1em;">≤3.0</span></td>
            </tr>
            <tr>
              <td class="item-label">近视临界点</td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <span style="color: #666;">{{ formatValue(calculateCriticalPoint(viewMode === 'edit' ? editForm.right_eye_k1 : record?.right_eye_k1, viewMode === 'edit' ? editForm.right_eye_k2 : record?.right_eye_k2)) }}</span>
                </template>
                <template v-else>{{ formatValue(calculateCriticalPoint(record?.right_eye_k1, record?.right_eye_k2)) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <span style="color: #666;">{{ formatValue(calculateCriticalPoint(viewMode === 'edit' ? editForm.left_eye_k1 : record?.left_eye_k1, viewMode === 'edit' ? editForm.left_eye_k2 : record?.left_eye_k2)) }}</span>
                </template>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.right_cct" :min="0" :precision="0" style="width: 100%" placeholder="μm" />
                </template>
                <template v-else>{{ formatValue(record?.right_cct) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.left_cct" :min="0" :precision="0" style="width: 100%" placeholder="μm" />
                </template>
                <template v-else>{{ formatValue(record?.left_cct) }}</template>
              </td>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.right_anterior_chamber_depth" :min="0" :precision="2" :step="0.01" style="width: 100%" placeholder="mm" />
                </template>
                <template v-else>{{ formatValue(record?.right_anterior_chamber_depth) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.left_anterior_chamber_depth" :min="0" :precision="2" :step="0.01" style="width: 100%" placeholder="mm" />
                </template>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.right_lens_thickness" :min="0" :precision="2" :step="0.01" style="width: 100%" placeholder="mm" />
                </template>
                <template v-else>{{ formatValue(record?.right_lens_thickness) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.left_lens_thickness" :min="0" :precision="2" :step="0.01" style="width: 100%" placeholder="mm" />
                </template>
            ...
            <tr>
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.right_vitreous_space_thickness" :min="0" :precision="2" :step="0.01" style="width: 100%" placeholder="mm" />
                </template>
                <template v-else>{{ formatValue(record?.right_vitreous_space_thickness) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.left_vitreous_space_thickness" :min="0" :precision="2" :step="0.01" style="width: 100%" placeholder="mm" />
                </template>
            ...
            <tr v-if="viewMode !== 'view' || hasChoroidThickness">
              ...
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.right_oct_fovea" :min="0" :precision="0" style="width: 100%" placeholder="μm" />
                </template>
                <template v-else>{{ formatValue(record?.right_oct_fovea) }}</template>
              </td>
              <td>
                <template v-if="viewMode === 'edit'">
                  <a-input-number v-bind="nonNegativeInputNumberBind" v-model:value="editForm.left_oct_fovea" :min="0" :precision="0" style="width: 100%" placeholder="μm" />
                </template>
...
.biometry-table tbody tr:nth-child(even) {
  background: #ffffff;
}

.biometry-table tbody tr:nth-child(odd) {
  background: #fafbff;
}
