<template>
  <div class="analysis-right-exam-container">
    <div class="analysis-content">
      <div class="analysis-header">
        <h3>结果分析 - 右屏</h3>
        <p class="analysis-description">基于检查数据进行智能分析和建议</p>
      </div>
...
watch(() => props.isDualScreen, (newIsDualScreen) => {
  console.log('=== 结果分析页面(右屏) - 双屏模式 ===')
  console.log('是否为双屏模式:', newIsDualScreen)
}, { immediate: true })
</script>

<style scoped lang="scss">
.analysis-right-exam-container {
  padding: 16px;
  background: #fff;
  border-radius: 8px;
}
