  ...
  <a-spin :spinning="isLoading">
    <div class="wrapper">
      ...
      >
        <template #title>
          <div
            ...
            <a-space>
              <a-button v-if="false" class="print-btn modal-btn" type="primary" @click="handleOpenExaminationReportPrint">
                检查报告
              </a-button>
                ...
                <a-col :span="24">
                  <div style="margin-left: 24px" class="vision-group">
                    ...
                    <div class="vision-item-wrapper">
                      ...
                      <div class="vision-suffix-row">
                        <a-input-group compact class="vision-suffix-group">
                          <a-select
                              v-model:value="currentRecord.uva_right_vision_sign"
                              class="vision-sign-select"
                              placeholder="±"
                              allowClear
                          >
                          ...
                          <a-input-number
                              v-model:value="currentRecord.uva_right_vision_level"
                              class="vision-level-input"
                              :min="0"
                              :max="9"
                              :precision="0"
                              placeholder="个"
                    ...
                    <div class="vision-item-wrapper" style="margin-left: 12px;">
                      <a-input-group compact>
                        <a-input
                            class="modal-input modal-input-compact"
                      ...
                      <div class="vision-suffix-row">
                        <a-input-group compact class="vision-suffix-group">
                          <a-select
                              v-model:value="currentRecord.uva_left_vision_sign"
                              class="vision-sign-select"
                              placeholder="±"
                              allowClear
                          >
                          ...
                          <a-input-number
                              v-model:value="currentRecord.uva_left_vision_level"
                              class="vision-level-input"
                              :min="0"
                              :max="9"
                              :precision="0"
                    ...
                    <div class="vision-item-wrapper" style="margin-left: 12px;">
                      ...
                      <div class="vision-suffix-row">
                        <a-input-group compact class="vision-suffix-group">
                          <a-select
                              v-model:value="currentRecord.uva_both_vision_sign"
                              class="vision-sign-select"
                              placeholder="±"
                              allowClear
                          >
                          ...
                          <a-input-number
                              v-model:value="currentRecord.uva_both_vision_level"
                              class="vision-level-input"
                              :min="0"
                              :max="9"
                              :precision="0"
              ...
              <a-row :gutter="16" style="margin-top: 16px;">
                <a-col :span="24">
                  <div class="vision-group">
                    ...
                    <div class="vision-item-wrapper" :class="{ 'disabled-group': !hasGlasses }">
                      <a-input-group compact>
                        <a-input
                            class="modal-input modal-input-compact"
                      ...
                      <div class="vision-suffix-row">
                        <a-input-group compact class="vision-suffix-group">
                          <a-select
                              v-model:value="currentRecord.vaec_right_old_vision_sign"
                              class="vision-sign-select"
                              placeholder="±"
                              allowClear
                              :disabled="!hasGlasses"
                          ...
                          <a-input-number
                              v-model:value="currentRecord.vaec_right_old_vision_level"
                              class="vision-level-input"
                              :min="0"
                              :max="9"
                              :precision="0"
                    ...
                    <div class="vision-item-wrapper" style="margin-left: 12px;" :class="{ 'disabled-group': !hasGlasses }">
                      <a-input-group compact>
                        <a-input
                            class="modal-input modal-input-compact"
                      ...
                      <div class="vision-suffix-row">
                        <a-input-group compact class="vision-suffix-group">
                          <a-select
                              v-model:value="currentRecord.vaec_left_old_vision_sign"
                              class="vision-sign-select"
                              placeholder="±"
                              allowClear
                              :disabled="!hasGlasses"
                          ...
                          <a-input-number
                              v-model:value="currentRecord.vaec_left_old_vision_level"
                              class="vision-level-input"
                              :min="0"
                              :max="9"
                              :precision="0"
                    ...
                    <div class="vision-item-wrapper" style="margin-left: 12px;" :class="{ 'disabled-group': !hasGlasses }">
                      ...
                      <div class="vision-suffix-row">
                        <a-input-group compact class="vision-suffix-group">
                          <a-select
                              v-model:value="currentRecord.vaec_both_old_vision_sign"
                              class="vision-sign-select"
                              placeholder="±"
                              allowClear
                              :disabled="!hasGlasses"
                          ...
                          <a-input-number
                              v-model:value="currentRecord.vaec_both_old_vision_level"
                              class="vision-level-input"
                              :min="0"
                              :max="9"
                              :precision="0"
      ...
      <a-modal
          ...
          width="90%"
          :footer="null"
          @cancel="examinationReportPrintVisible = false"
          :maskClosable="false"
          :keyboard="false"
      >
        <template #title>
          <div style="display: flex; align-items: center; justify-content: space-between; padding-bottom: 16px; margin-bottom: 16px; border-bottom: 1px solid rgba(0,0,0,0.1);">
            <div style="display: flex; align-items: center;">
              <img-icon class="header-icon" title="打印"/>
              检查报告打印预览
            </div>
            <a-space>
              <a-button type="primary" @click="handleExaminationReportPrint">打印</a-button>
              <a-button @click="examinationReportPrintVisible = false">关闭</a-button>
            </a-space>
          </div>
        </template>
        <ExaminationReportPreview
            ref="examinationReportPreviewRef"
            :examination-data="currentRecord"
            :logo-url="logoUrl"
            :org-name="orgName"
        />
      </a-modal>
...
import ExaminationReportPreview from '@/pages/components/ExaminationReportPreview.vue';
...
export default defineComponent({
  ...
  setup() {
        ...
        if (response.ok && data && data.data) {
          ...
          try {
            ...
            if (storageError.name === 'QuotaExceededError') {
              console.warn('⚠️ localStorage存储空间不足，尝试清理旧数据');
              // 清理旧的缓存数据
              try {
                ...
                // 重新尝试存储
                localStorage.setItem('checkmanagementlist', JSON.stringify(finalMergedData));
                console.log('✅ localStorage缓存清理后重新存储成功');
              } catch (retryError) {
                console.error('❌ localStorage存储失败，将仅使用IndexedDB:', retryError);
                // 标记仅使用IndexedDB
                localStorage.setItem('checkmanagementlist_storage', 'indexedDB_only');
              }
            } else {
    ...
    // 格式化视力值用于输入框显示（兼容整数）
    // 如果后端返回整数1，转换为"1.0"显示
    const formatVisionForInput = (value) => {
      ...
      // 如果第二位小数是0，返回1位小数格式（兼容整数和1位小数）
      // 例如：1 -> "1.00" -> 返回"1.0"
      // 例如：1.2 -> "1.20" -> 返回"1.2"
      // 例如：0.05 -> "0.05" -> 返回"0.05"（第二位不为0）
    ...
    const handleView = async (record) => {
      // 格式化视力相关字段，确保整数显示为1.0格式
      const visionFields = [
        'uva_right_vision', 'uva_left_vision', 'uva_both_vision',
        'vaec_right_old_vision', 'vaec_left_old_vision', 'vaec_both_old_vision'
      ];
      
      const formattedExamination = { ...record.examination };
      visionFields.forEach(field => {
        if (formattedExamination[field] !== null && formattedExamination[field] !== undefined && formattedExamination[field] !== '') {
          formattedExamination[field] = formatVisionForInput(formattedExamination[field]);
        }
      });

      currentRecord.value = {
        ...formattedExamination,
      ...
      // 检查双眼方案是否不同，如果不同则不默认勾选双眼同步
      const hasDifferentEyes = 
        (currentRecord.value.right_atropine !== currentRecord.value.left_atropine) ||
        (currentRecord.value.right_glasses !== currentRecord.value.left_glasses) ||
        (currentRecord.value.right_glasses_pp !== currentRecord.value.left_glasses_pp) ||
        (currentRecord.value.right_hg !== currentRecord.value.left_hg) ||
        (currentRecord.value.right_hg_dw !== currentRecord.value.left_hg_dw) ||
        (currentRecord.value.right_physiotherapy !== currentRecord.value.left_physiotherapy) ||
        (currentRecord.value.right_visual_training !== currentRecord.value.left_visual_training);
      
      // 只有在双眼方案相同时才默认勾选双眼同步
      syncEyes.value = !hasDifferentEyes;
      ...
      try {
        ...
        const submitData = {
          ...
          data: {
            ...
            uva_right_vision_sign: (currentRecord.value.uva_right_vision != null && currentRecord.value.uva_right_vision !== '') ? (currentRecord.value.uva_right_vision_sign || '+') : null,
            uva_right_vision_level: currentRecord.value.uva_right_vision_level !== null && currentRecord.value.uva_right_vision_level !== undefined ? parseInt(currentRecord.value.uva_right_vision_level) : null,
            ...
            uva_left_vision_sign: (currentRecord.value.uva_left_vision != null && currentRecord.value.uva_left_vision !== '') ? (currentRecord.value.uva_left_vision_sign || '+') : null,
            uva_left_vision_level: currentRecord.value.uva_left_vision_level !== null && currentRecord.value.uva_left_vision_level !== undefined ? parseInt(currentRecord.value.uva_left_vision_level) : null,
            ...
            uva_both_vision_sign: (currentRecord.value.uva_both_vision != null && currentRecord.value.uva_both_vision !== '') ? (currentRecord.value.uva_both_vision_sign || '+') : null,
            uva_both_vision_level: currentRecord.value.uva_both_vision_level !== null && currentRecord.value.uva_both_vision_level !== undefined ? parseInt(currentRecord.value.uva_both_vision_level) : null,
            ...
            vaec_right_old_vision_sign: (currentRecord.value.vaec_right_old_vision != null && currentRecord.value.vaec_right_old_vision !== '') ? (currentRecord.value.vaec_right_old_vision_sign || '+') : null,
            vaec_right_old_vision_level: currentRecord.value.vaec_right_old_vision_level !== null && currentRecord.value.vaec_right_old_vision_level !== undefined ? parseInt(currentRecord.value.vaec_right_old_vision_level) : null,
            ...
            vaec_left_old_vision_sign: (currentRecord.value.vaec_left_old_vision != null && currentRecord.value.vaec_left_old_vision !== '') ? (currentRecord.value.vaec_left_old_vision_sign || '+') : null,
            vaec_left_old_vision_level: currentRecord.value.vaec_left_old_vision_level !== null && currentRecord.value.vaec_left_old_vision_level !== undefined ? parseInt(currentRecord.value.vaec_left_old_vision_level) : null,
            ...
            vaec_both_old_vision_sign: (currentRecord.value.vaec_both_old_vision != null && currentRecord.value.vaec_both_old_vision !== '') ? (currentRecord.value.vaec_both_old_vision_sign || '+') : null,
            vaec_both_old_vision_level: currentRecord.value.vaec_both_old_vision_level !== null && currentRecord.value.vaec_both_old_vision_level !== undefined ? parseInt(currentRecord.value.vaec_both_old_vision_level) : null,
            ...
            right_eye_axial_length: (() => {
              const raw = currentRecord.value.right_eye_axial_length;
              if (raw === null || raw === undefined || raw === '') return null;
              const n = parseFloat(raw);
              if (Number.isNaN(n) || n < 0) return null;
              return n;
            })(),
            left_eye_axial_length: (() => {
              const raw = currentRecord.value.left_eye_axial_length;
              if (raw === null || raw === undefined || raw === '') return null;
              const n = parseFloat(raw);
              if (Number.isNaN(n) || n < 0) return null;
              return n;
        ...
        // 后端返回格式: { "success": true, "message": "记录更新成功", ... }
    ...
    const handleSyncLastVaec = async () => {
      ...
      if (!currentRecord.value.patient_id) {
        message.error('未找到患者ID，无法同步');
        return;
      }

      try {
        // 先从服务器获取该患者的所有检查记录
        message.loading('正在从服务器获取检查记录...', 0);
        const allExaminations = await fetchPatientExaminationsFromServer(currentRecord.value.patient_id);
        message.destroy();

        if (!allExaminations || allExaminations.length === 0) {
          message.error('未找到该患者的历史检查记录');
          return;
        }
        ...
        if (currentIndex === -1) {
          message.error('未找到当前检查记录');
          return;
        }

        // 从当前记录之前的记录开始，按时间顺序往前查找，找到最近的有旧镜度数数据的记录
        let lastExamination = null;
        for (let i = currentIndex + 1; i < patientExaminations.length; i++) {
          const exam = patientExaminations[i].examination;
          const hasVaecData = (exam.vaec_right_spherical !== null && exam.vaec_right_spherical !== undefined) ||
              (exam.vaec_right_cylindrical !== null && exam.vaec_right_cylindrical !== undefined) ||
              (exam.vaec_right_axis !== null && exam.vaec_right_axis !== undefined) ||
              (exam.vaec_left_spherical !== null && exam.vaec_left_spherical !== undefined) ||
              (exam.vaec_left_cylindrical !== null && exam.vaec_left_cylindrical !== undefined) ||
              (exam.vaec_left_axis !== null && exam.vaec_left_axis !== undefined);
        ...
        // 如果所有历史记录都没有旧镜度数数据，提示用户
        if (!lastExamination) {
          message.warning('该患者的历史检查记录中都没有旧镜度数数据，无法同步');
          return;
        }
    ...
    // 打开检查报告打印预览
    const handleOpenExaminationReportPrint = async () => {
    ...
    const handleExaminationReportPrint = async () => {
      try {
        ...
        if (!examinationReportPreviewRef.value || !examinationReportPreviewRef.value.printAreaRef) {
          message.error('打印预览区域未找到');
          return;
        }

        const printElement = examinationReportPreviewRef.value.printAreaRef;
        if (!printElement) {
        ...
        if (window.require && window.require('electron')) {
          try {
            ...
            console.warn('Electron IPC 打印失败，尝试使用浏览器打印:', electronError);
          }
        }
        ...
        if (printWindow) {
          ...
          message.error('打印窗口被阻止，请检查浏览器弹窗设置');
        }
      } catch (error) {
        message.destroy();
    ...
    const fetchSystemSettings = async () => {
      try {
        ...
        if (data.code === 200) {
          ...
          // 优先使用API响应中的logo字段
          if (orgData.logo && orgData.logo.trim() !== '') {
            console.log('从API响应中获取logo URL:', orgData.logo);
            try {
              // 将logo URL转换为base64用于打印
              const base64Data = await convertImageToBase64(orgData.logo);
              logoUrl.value = base64Data;
              
              // 保存到本地存储
              localStorage.setItem('cached_logo_base64', base64Data);
              localStorage.setItem('cached_logo_timestamp', Date.now().toString());
              console.log('Logo已从API响应获取并转换为base64');
            } catch (error) {
              console.warn('转换logo URL为base64失败，使用URL:', error);
              // 如果转换失败，直接使用URL
              logoUrl.value = orgData.logo;
            }
          } else {
            // 如果API响应中没有logo字段，回退到调用单独的logo端点
            console.log('API响应中没有logo字段，尝试从logo端点获取');
    ...
    const handlePrintConfirm = async () => {
      ...
      // 按优先级获取打印区域：1) 复查报告专属标识 2) PrintPreview 组件内 3) 全局首个可见的
      let previewArea = document.querySelector('[data-print-target="review-report"]');
      if (!previewArea) {
        const printPreviewRoot = printPreviewRef.value?.$el;
        previewArea = printPreviewRoot?.querySelector?.('.a4-preview-box');
      }
      if (!previewArea) {
        previewArea = document.querySelector('.a4-preview-box');
      }
      if (!previewArea) {
        message.error('未找到打印区域');
        return;
      }
      // 确认选中的是复查报告（包含「复查报告」标题）
      const reportTitle = previewArea.querySelector('.report-title');
      const isReviewReport = reportTitle?.textContent?.includes('复查报告');
      console.log('打印目标确认:', {
        selector: previewArea.getAttribute('data-print-target') || 'fallback',
        hasReportTitle: !!reportTitle,
        titleText: reportTitle?.textContent,
        isReviewReport,
        patientName: previewArea.querySelector('.patient-info-row')?.textContent?.slice(0, 50)
      });
      if (!isReviewReport) {
        console.warn('⚠️ 可能选错了打印区域！当前区域标题:', reportTitle?.textContent || '无');
      }
      ...
      try {
        ...
        while (retryCount <= maxRetries) {
          try {
            ...
            // 使用优化的 html2canvas 配置，确保生成标准A4尺寸图片
            canvas = await html2canvas(previewArea, {
          useCORS: true,
          allowTaint: true,
          backgroundColor: '#fff',
          scale: 2, // 保持2倍缩放以确保图片清晰度
          logging: false, // 关闭日志以提高性能
          imageTimeout: 30000, // 增加超时时间
          removeContainer: false,
          foreignObjectRendering: false, // 禁用foreignObject渲染以提高兼容性
          width: 794, // 强制A4宽度（210mm）
          height: 1123, // 强制A4高度（297mm）
          // 确保生成的图片尺寸精确匹配A4标准
          windowWidth: 794,
          windowHeight: 1123,
          ignoreElements: (element) => {
            // 忽略所有非目标预览框，确保只渲染复查报告
            if (element.classList?.contains('a4-preview-box') && element.getAttribute('data-print-target') !== 'review-report') {
              console.log('忽略非目标预览框，避免渲染错误内容');
              return true;
            }
            return false;
          },
              ...
              // 关键修复：使克隆文档只包含目标预览区域，避免捕获到其他 modal/页面内容
              const clonedA4Box = clonedDoc.querySelector('[data-print-target="review-report"]');
              if (clonedA4Box) {
                const body = clonedDoc.body;
                const html = clonedDoc.documentElement;
                body.innerHTML = '';
                body.style.cssText = 'margin:0;padding:0;background:#fff;display:flex;justify-content:center;align-items:flex-start;min-height:100vh;';
                html.style.cssText = 'margin:0;padding:0;';
                const wrapper = clonedDoc.createElement('div');
                wrapper.style.cssText = 'width:794px;height:1123px;background:#fff;';
                wrapper.appendChild(clonedA4Box);
                body.appendChild(wrapper);
                clonedA4Box.style.width = '794px';
                clonedA4Box.style.height = '1123px';
                clonedA4Box.style.transform = 'none';
                clonedA4Box.style.maxWidth = 'none';
                clonedA4Box.style.maxHeight = 'none';
                console.log('已隔离目标预览区域为克隆文档的唯一内容');
              }
              
              // 确保克隆的文档中的图片能够正确加载（仅在目标预览框内查找）
              const targetBox = clonedDoc.querySelector('[data-print-target="review-report"]');
              const clonedImages = targetBox ? targetBox.querySelectorAll('img') : [];
              ...
              // 确保预览区域可见（此时文档仅含目标预览框）
              const clonedPreviewArea = clonedDoc.querySelector('[data-print-target="review-report"]');
              ...
              // 确保logo在右上角（打印时）
              const clonedLogo = clonedDoc.querySelector('.logo-fixed');
              if (clonedLogo) {
                clonedLogo.style.position = 'absolute';
                clonedLogo.style.top = '10px';
                clonedLogo.style.right = '40px';
                clonedLogo.style.left = 'auto';  // 清除left属性
                clonedLogo.style.maxWidth = '72px';
                clonedLogo.style.maxHeight = '48px';
                console.log('确保克隆文档中的logo在右上角');
              }
              
              // 确保机构名在左上角（打印时）
              const clonedOrgName = clonedDoc.querySelector('.orgname-fixed');
              if (clonedOrgName) {
                clonedOrgName.style.position = 'absolute';
                clonedOrgName.style.top = '14px';
                clonedOrgName.style.left = '32px';
                clonedOrgName.style.right = 'auto';  // 清除right属性
                clonedOrgName.style.fontSize = '24px';
                clonedOrgName.style.fontWeight = '700';
                clonedOrgName.style.color = '#1976d2';
                console.log('确保克隆文档中的机构名在左上角');
              }
              ...
              // 验证克隆后的图片状态
              const clonedImageValidationResults = validateImages(clonedA4Box || clonedDoc);
        ...
        // 尝试使用 Electron IPC 打印（如果可用）
        if (window.require && window.require('electron')) {
          try {
            const { ipcRenderer } = window.require('electron');
            await ipcRenderer.invoke('print-qrcode', imgData);
            message.success('打印指令已发送');
            return;
          } catch (electronError) {
            console.warn('Electron IPC 打印失败，尝试使用浏览器打印:', electronError);
            // 如果 Electron IPC 失败，继续使用 window.open
          }
        }
        ...
        if (printWindow) {
          ...
          // window.open 被阻止，提示用户
          message.error('打印窗口被阻止，请检查浏览器弹窗设置或使用 Electron 打印功能');
          console.error('window.open 返回 null，可能被浏览器阻止');
        }
      } catch (err) {
        message.destroy();
    ...
    // 从服务器获取该患者的所有检查记录
    const fetchPatientExaminationsFromServer = async (patientId) => {
      try {
        const csrftoken = localStorage.getItem('csrftoken');
        const response = await fetch('https://aiforoptometry.com/medicalrecords/allrecords_patient_id_2', {
          method: 'POST',
        ...
        const recordsData = await response.json();
        console.log('从服务器获取的患者检查记录:', recordsData);

        if (recordsData.examination_records && Array.isArray(recordsData.examination_records)) {
          // 将API返回的格式转换为Examination1.vue中使用的格式
          const convertedExaminations = recordsData.examination_records.map(record => ({
            examination_id: record.id,
            patient_id: record.patient_id || record.patient_id_id,
            examination: record,
          ...
          console.warn('服务器返回的数据格式不正确:', recordsData);
          return [];
        }
      } catch (error) {
        console.error('从服务器获取患者检查记录失败:', error);
        throw error;
      }
    };
    ...
    const handleSyncLastBasic = async () => {
      ...
      try {
        ...
        // 从当前记录之前的记录开始，按时间顺序往前查找，找到最近的有基本数据的记录
        let lastExamination = null;
        for (let i = currentIndex + 1; i < patientExaminations.length; i++) {
          const exam = patientExaminations[i].examination;
          const hasBasicData = exam.height !== null && exam.height !== undefined &&
              exam.weight !== null && exam.weight !== undefined;
        ...
        // 如果所有历史记录都没有基本数据，提示用户
        if (!lastExamination) {
          message.warning('该患者的历史检查记录中都没有基本数据（身高、体重），无法同步');
          return;
        }
    ...
    const handleSyncLastVision = async () => {
      ...
      try {
        ...
        // 从当前记录之前的记录开始，按时间顺序往前查找，找到最近的有视力数据的记录
        let lastExamination = null;
        for (let i = currentIndex + 1; i < patientExaminations.length; i++) {
          const exam = patientExaminations[i].examination;
          // 检查是否有裸眼视力数据
          const hasVisionData = exam.uva_right_vision !== null && exam.uva_right_vision !== undefined &&
              exam.uva_left_vision !== null && exam.uva_left_vision !== undefined &&
              exam.uva_both_vision !== null && exam.uva_both_vision !== undefined;
          // 检查是否有戴镜视力数据
          const hasVaecData = exam.vaec_right_old_vision !== null && exam.vaec_right_old_vision !== undefined &&
              exam.vaec_left_old_vision !== null && exam.vaec_left_old_vision !== undefined &&
              exam.vaec_both_old_vision !== null && exam.vaec_both_old_vision !== undefined;
        ...
        // 如果所有历史记录都没有视力数据，提示用户
        if (!lastExamination) {
          message.warning('该患者的历史检查记录中都没有视力检查数据，无法同步');
          return;
        }
        ...
        // 同步裸眼视力数据（格式化视力值，确保整数显示为1.0）
        if (hasVisionData) {
          updatedData.uva_right_vision = formatVisionForInput(lastExamination.uva_right_vision);
          updatedData.uva_right_vision_sign = lastExamination.uva_right_vision_sign;
          updatedData.uva_right_vision_level = lastExamination.uva_right_vision_level;
          updatedData.uva_left_vision = formatVisionForInput(lastExamination.uva_left_vision);
          updatedData.uva_left_vision_sign = lastExamination.uva_left_vision_sign;
          updatedData.uva_left_vision_level = lastExamination.uva_left_vision_level;
          updatedData.uva_both_vision = formatVisionForInput(lastExamination.uva_both_vision);
          updatedData.uva_both_vision_sign = lastExamination.uva_both_vision_sign;
          updatedData.uva_both_vision_level = lastExamination.uva_both_vision_level;
        }

        // 同步戴镜视力数据（格式化视力值，确保整数显示为1.0）
        if (hasVaecData) {
          updatedData.vaec_right_old_vision = formatVisionForInput(lastExamination.vaec_right_old_vision);
          updatedData.vaec_right_old_vision_sign = lastExamination.vaec_right_old_vision_sign;
          updatedData.vaec_right_old_vision_level = lastExamination.vaec_right_old_vision_level;
          updatedData.vaec_left_old_vision = formatVisionForInput(lastExamination.vaec_left_old_vision);
          updatedData.vaec_left_old_vision_sign = lastExamination.vaec_left_old_vision_sign;
          updatedData.vaec_left_old_vision_level = lastExamination.vaec_left_old_vision_level;
          updatedData.vaec_both_old_vision = formatVisionForInput(lastExamination.vaec_both_old_vision);
          updatedData.vaec_both_old_vision_sign = lastExamination.vaec_both_old_vision_sign;
          updatedData.vaec_both_old_vision_level = lastExamination.vaec_both_old_vision_level;
          // 自动勾选戴镜视力
    ...
    const handleSyncLastObjective = async () => {
      ...
      try {
        ...
        // 从当前记录之前的记录开始，按时间顺序往前查找，找到最近的有电脑验光数据的记录
        let lastExamination = null;
        for (let i = currentIndex + 1; i < patientExaminations.length; i++) {
          const exam = patientExaminations[i].examination;
          const hasObjectiveData = exam.objective_right_spherical !== null && exam.objective_right_spherical !== undefined &&
              exam.objective_right_cylindrical !== null && exam.objective_right_cylindrical !== undefined &&
              exam.objective_right_axis !== null && exam.objective_right_axis !== undefined &&
              exam.objective_left_spherical !== null && exam.objective_left_spherical !== undefined &&
              exam.objective_left_cylindrical !== null && exam.objective_left_cylindrical !== undefined &&
              exam.objective_left_axis !== null && exam.objective_left_axis !== undefined;
        ...
        // 如果所有历史记录都没有电脑验光数据，提示用户
        if (!lastExamination) {
          message.warning('该患者的历史检查记录中都没有电脑验光数据，无法同步');
          return;
        }
    ...
    const handleSyncLastTreatment = async () => {
      ...
      try {
        ...
        // 从当前记录之前的记录开始，按时间顺序往前查找，找到最近的有诊疗方案数据的记录
        let lastExamination = null;
        for (let i = currentIndex + 1; i < patientExaminations.length; i++) {
          const exam = patientExaminations[i].examination;
          
          // 检查是否有诊疗方案数据（使用与完善判定相同的逻辑）
          const hasRightAtropine = exam.right_atropine !== null && exam.right_atropine !== undefined && exam.right_atropine !== '';
          const hasRightGlasses = exam.right_glasses !== null && exam.right_glasses !== undefined && exam.right_glasses !== '';
          const hasRightHg = exam.right_hg !== null && exam.right_hg !== undefined && exam.right_hg !== '';
          const hasRightPhysiotherapy = exam.right_physiotherapy !== null && exam.right_physiotherapy !== undefined && exam.right_physiotherapy !== '';
          const hasRightVisualTraining = exam.right_visual_training !== null && exam.right_visual_training !== undefined && exam.right_visual_training !== '';
          
          const hasLeftAtropine = exam.left_atropine !== null && exam.left_atropine !== undefined && exam.left_atropine !== '';
          const hasLeftGlasses = exam.left_glasses !== null && exam.left_glasses !== undefined && exam.left_glasses !== '';
          const hasLeftHg = exam.left_hg !== null && exam.left_hg !== undefined && exam.left_hg !== '';
          const hasLeftPhysiotherapy = exam.left_physiotherapy !== null && exam.left_physiotherapy !== undefined && exam.left_physiotherapy !== '';
          const hasLeftVisualTraining = exam.left_visual_training !== null && exam.left_visual_training !== undefined && exam.left_visual_training !== '';
          
          const hasRightGlassesPP = (exam.right_glasses === '否') || 
              (exam.right_glasses && exam.right_glasses !== '否' && 
               exam.right_glasses_pp !== null && exam.right_glasses_pp !== undefined && exam.right_glasses_pp !== '');
          
          const hasRightHgDW = (exam.right_hg === '否') || 
              (exam.right_hg && exam.right_hg !== '否' && 
               exam.right_hg_dw !== null && exam.right_hg_dw !== undefined && exam.right_hg_dw !== '');
          
          const hasLeftGlassesPP = (exam.left_glasses === '否') || 
              (exam.left_glasses && exam.left_glasses !== '否' && 
               exam.left_glasses_pp !== null && exam.left_glasses_pp !== undefined && exam.left_glasses_pp !== '');
          
          const hasLeftHgDW = (exam.left_hg === '否') || 
              (exam.left_hg && exam.left_hg !== '否' && 
               exam.left_hg_dw !== null && exam.left_hg_dw !== undefined && exam.left_hg_dw !== '');
        ...
        // 如果所有历史记录都没有诊疗方案数据，提示用户
        if (!lastExamination) {
          message.warning('该患者的历史检查记录中都没有诊疗方案数据，无法同步');
          return;
        }
    ...
    return {
      ...
      printModalVisible,
      printModalLoading,
      examinationReportPrintVisible,
      examinationReportPreviewRef,
      handleOpenExaminationReportPrint,
      handleExaminationReportPrint,
      printData,
      selectedPrintFields,
      historyRecords,
      selectedPrintExams,
...
.vision-item-wrapper {
  ...
  align-items: flex-start;
  gap: 4px;
  width: 110px; /* 固定宽度：70px输入框 + 40px按钮 */
}

.vision-item-wrapper.disabled-group {
  opacity: 0.65;
}
...
.vision-suffix-group {
  display: flex;
  align-items: center;
  width: 115px; /* 固定宽度：60px符号 + 55px级别，与上方输入框对齐 */
}
...
.vision-sign-select :deep(.ant-select-selector) {
...
.vision-sign-select :deep(.ant-select-selection-item) {
...
.vision-level-input :deep(.ant-input-number-input) {
  height: 40px !important;
  text-align: center;
  padding: 0 8px !important;
...
.vision-level-input :deep(.ant-input-number) {
  height: 40px !important;
}

.vision-suffix-group :deep(.ant-input-group) {
  display: flex;
  border-radius: 8px;
  border: 1px solid #E27244;
  overflow: hidden;
...
.vision-suffix-group :deep(.ant-select) {
  border: none;
}

.vision-suffix-group :deep(.ant-input-number) {
  border: none;
}
